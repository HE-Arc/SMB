...
WebUI.click(findTestObject('Object Repository/Page_Spring Boot Thymeleaf/td_20 avril 2019 1631'))

WebUI.click(findTestObject('Object Repository/Page_Spring Boot Thymeleaf/i_Comment_fas fa-trash'))
