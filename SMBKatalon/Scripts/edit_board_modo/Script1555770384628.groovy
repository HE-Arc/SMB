...
WebUI.setText(findTestObject('Page_Spring Boot Thymeleaf/input_Username_username'), 'lewislewis')
...
WebUI.click(findTestObject('Page_Spring Boot Thymeleaf/i_test_fas fa-pen'))

WebUI.setText(findTestObject('Page_Spring Boot Thymeleaf/input_Board name_name'), 'test edit')

WebUI.setText(findTestObject('Page_Spring Boot Thymeleaf/textarea_test'), 'test edit')

WebUI.click(findTestObject('Page_Spring Boot Thymeleaf/button_Save'))
