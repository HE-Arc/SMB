    ...
    stages {
        ...
        stage('IntegrationTest') {
            ...
            steps {
                ...
                sh 'sleep 30'
			    sh '(/Katalon_Studio_Linux_64-5.7.1/katalon -noSplash  -runMode=console -projectPath="SMBKatalon/SMBKatalon.prj" -retry=0 -testSuitePath="Test Suites/full_test" -executionProfile="default" -browserType="Web Service")'
			    cleanWs()
            }
            post {
                always {
